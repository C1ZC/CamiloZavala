      ...
      <Container>
        <Row className="align-items-center">
          ...
          <div className="social-icon">
                  <a onClick={() => window.location.href='mailto:camilo.zavala.c@gmail.com?subject=contacto&body='} target="_blank" rel="noopener noreferrer"><img src={navIcon4} alt="Instagram" /></a>
